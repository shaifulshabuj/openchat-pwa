...
const nextConfig: NextConfig = {
  ...
  basePath: process.env.STATIC_EXPORT === 'true' ? (process.env.NEXT_PUBLIC_BASE_PATH || '/openchat-pwa') : '',
  assetPrefix: process.env.STATIC_EXPORT === 'true' ? (process.env.NEXT_PUBLIC_BASE_PATH || '/openchat-pwa') : '',
  images: {
    unoptimized: true,
  },
  ...
  env: {
    ...
    NEXT_PUBLIC_BASE_PATH: process.env.STATIC_EXPORT === 'true' ? (process.env.NEXT_PUBLIC_BASE_PATH || '/openchat-pwa') : '',
  },
}
